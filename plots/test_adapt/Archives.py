...
from Adaptor import Adaptor_xy, Adaptor_arc, Combined_adaptor_xy, Combined_adaptor_arc
import math
import os
import copy
import json
...
class Archive_xy(Archive):
    ...
    def build_adaptor(self):
        ...
        xy_adaptor = Adaptor_xy((x_gps, y_gps), np.array(prior_weights))
        adaptor = Combined_adaptor_xy(adaptor_xy=xy_adaptor, alpha=self.alpha, N=total_size)
        return adaptor
...
class Archive_arc(Archive):
    ...
    def build_adaptor(self):
        ...
        arc_adaptor = Adaptor_arc((v_gps, w_gps, phi_gps), np.array(prior_weights))
        adaptor = Combined_adaptor_arc(adaptor_arc=arc_adaptor, alpha=self.alpha, N=total_size)
        return adaptor
