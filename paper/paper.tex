...
%To achieve this, we first assume that the sum of uncertainties for the final coordinates, namely $\sigma_x^2 + \sigma_y^2$, has the same value for all policies.
%Considering the robot will also have periodic deviations from the arc trajectory during its motion.
%The position is a superposition of the trajectory and the deviation.
%We can treat this deviation as an random variable and decouple it from the final coordinates to get:
